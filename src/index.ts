 ...
 *
 * ⚠️ **It uses nothing this package does not export.** That is the point: an emitter built on this
 * library is written exactly like this one, so "the public API is sufficient to build an emitter" is
 * proved by construction rather than hoped for. If this function ever needs something private, the
 * API is wrong.
 */
